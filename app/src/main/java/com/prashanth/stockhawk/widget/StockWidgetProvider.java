package com.prashanth.stockhawk.widget;
...
import com.prashanth.stockhawk.R;
import com.prashanth.stockhawk.ui.StockDetails;
...
public class StockWidgetProvider extends AppWidgetProvider {
    ...
    public static final String INTENT_ACTION = "com.prashanth.stockhawk.widget.StockWidgetProvider.INTENT_ACTION";
    public static final String EXTRA_SYMBOL = "com.prashanth.stockhawk.widget.StockWidgetProvider.EXTRA_SYMBOL";
    public static final String EXTRA_NAME = "com.prashanth.stockhawk.widget.StockWidgetProvider.EXTRA_NAME";
    public static final String EXTRA_CURRENCY = "com.prashanth.stockhawk.widget.StockWidgetProvider.EXTRA_CURRENCY";
    public static final String EXTRA_LASTTRADEDATE = "com.prashanth.stockhawk.widget.StockWidgetProvider.EXTRA_LASTTRADEDATE";
    public static final String EXTRA_DAYLOW = "com.prashanth.stockhawk.widget.StockWidgetProvider.EXTRA_DAYLOW";
    public static final String EXTRA_DAYHIGH = "com.prashanth.stockhawk.widget.StockWidgetProvider.EXTRA_DAYHIGH";
    public static final String EXTRA_YEARLOW = "com.prashanth.stockhawk.widget.StockWidgetProvider.EXTRA_YEARLOW";
    public static final String EXTRA_YEARHIGH = "com.prashanth.stockhawk.widget.StockWidgetProvider.EXTRA_YEARHIGH";
    public static final String EXTRA_EARNINGSSHARE = "com.prashanth.stockhawk.widget.StockWidgetProvider.EXTRA_EARNINGSSHARE";
    public static final String EXTRA_MARKETCAPITALIZATION = "com.prashanth.stockhawk.widget.StockWidgetProvider.EXTRA_MARKETCAPITALIZATION";
