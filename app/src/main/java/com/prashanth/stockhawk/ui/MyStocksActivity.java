package com.prashanth.stockhawk.ui;
...
import com.prashanth.stockhawk.data.QuoteColumns;
import com.prashanth.stockhawk.data.QuoteProvider;
import com.prashanth.stockhawk.rest.QuoteCursorAdapter;
import com.prashanth.stockhawk.rest.RecyclerViewItemClickListener;
import com.prashanth.stockhawk.rest.Utils;
import com.prashanth.stockhawk.service.StockIntentService;
import com.prashanth.stockhawk.service.StockTaskService;
import com.google.android.gms.gcm.GcmNetworkManager;
import com.google.android.gms.gcm.PeriodicTask;
import com.google.android.gms.gcm.Task;
import com.prashanth.stockhawk.touch_helper.SimpleItemTouchHelperCallback;
import com.prashanth.stockhawk.widget.StockWidgetProvider;
...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
  ...
  public void noNetworkSnack() {
    ...
    Snackbar.make(coordinatorLayout, R.string.network_snack, Snackbar.LENGTH_LONG).show();
  }
  ...
  private void updateStocksWidget(){
    ...
    if(ids.length > 0) {
       ...
       * #{@link com.prashanth.stockhawk.widget.StockWidgetService.StockRVFactory} class.
       */
    ...
    protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
      ...
      if (token == SYMBOL_SEARCH_QUERY_TAG) {
        if (cursor != null && cursor.getCount() != 0) {
           ...
           */
          Snackbar.make(coordinatorLayout, R.string.already_saved, Snackbar.LENGTH_LONG).show();
        } else {
          /**
